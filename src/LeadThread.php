...
namespace LeadThread\Api;

use Exception;
use GuzzleHttp\Client;
use GuzzleHttp\Exception\BadResponseException;
use GuzzleHttp\Psr7\Response;
use LeadThread\Api\Exceptions\LeadThreadException;
...
class LeadThread
{
    ...
    {
        $this->resource = implode("/", explode("_", $name));
    ...
    protected function handleBadResponseException($e)
    {
        ...
        throw new LeadThreadException($message, $code, $e);
    }
}